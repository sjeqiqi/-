...
自动启用基于美国 NRC《小反刍动物营养需要》（2007）、Sahlu 等（2004）公开文献体系及《奶山羊饲养管理技术规范》（NY/T 2835-2015）的专业科学解读，确保稳定输出。
"""
...
SYSTEM_PROMPT = (
    ...
    "必须只输出一个 JSON 对象，格式为："
    '{"explanations": ["配方干物质与能量蛋白满足营养约束", "粗精搭配合理利于反刍"], "risks": ["换料时建议保持过渡"], "approved": true, "calibration_note": "审核通过"}。'
)
